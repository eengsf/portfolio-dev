  ...
  return (
    <>
      ...
      <p className="text-secondary mb-3">
        A graduate of Electrical Engineering with a focus on <span className='text-tertiary'>web programming</span>,
        particularly using <span className='text-tertiary'>React and Next.js</span>. Actively involved in creating and
        developing web projects to strengthen technical skills while applying
        experience in building efficient, responsive, and user-friendly web
        interfaces.
      </p>
      <p className="text-secondary mb-6">
        Previously experienced in embedded programming and control algorithms,
        as well as active participation in national-level robotics competitions,
        which helped sharpen <span className='text-tertiary'>problem-solving skills and systematic logical
        thinking.</span> 
      </p>
